...
//print(loudness);
if(loudness > 1){
	mist.transform.position -= new Vector3(loudness*.7f,0,0);
}
...
audio.clip = Microphone.Start(selectedDevice, true, 1, 44100);
